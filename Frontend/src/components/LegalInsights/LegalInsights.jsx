...
<div className="legal-insights-card legal-insights-risk-card">
  ...
  <div className="legal-insights-risk-section">
    ...
    <div className="legal-insights-risk-content">
      ...
      <div className="legal-insights-risk-meter">
        {/* Risk value display - positioned above the chart */}
        <div className="legal-insights-risk-value-display">
          ...
          <div className="risk-level-container">
            <span className="risk-level-badge">{riskLevel.toUpperCase()}</span>
          </div>
        </div>
